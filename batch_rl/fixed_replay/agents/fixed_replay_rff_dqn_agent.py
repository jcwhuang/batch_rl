...
from dopamine.agents.rff import rff_dqn_agent
import gin
import tensorflow.compat.v1 as tf


@gin.configurable
class FixedReplayRandomFourierFeaturesDQNAgent(rff_dqn_agent.RFFDQNAgent):
  """An implementation of the DQN agent with fixed replay buffer(s) and random fourier features."""
  ...
  def __init__(self, sess, num_actions, replay_data_dir, replay_suffix=None,
    ...
    super(FixedReplayRandomFourierFeaturesDQNAgent, self).__init__(sess, num_actions,
                                                                   init_checkpoint_dir=self._init_checkpoint_dir,
                                                                   **kwargs)
  ...
  def end_episode(self, reward):
    ...
    super(FixedReplayRandomFourierFeaturesDQNAgent, self).end_episode(reward)
